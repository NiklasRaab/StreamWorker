...
using StreamWorker.ViewModels.Account;
...
namespace StreamWorker.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private StreamWorkerUserManager _userManager;

        public ManageController()
        {
        }

        public ManageController(StreamWorkerUserManager userManager, SignInManager signInManager)
        {
        ...
        private StreamWorkerUserManager UserManager
        {
            get { return _userManager ?? HttpContext.GetOwinContext().GetUserManager<StreamWorkerUserManager>(); }
        ...
        public async Task<ActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            var code =
                await UserManager.GenerateChangePhoneNumberTokenAsync(User.Identity.GetUserId<int>(), model.Number);
