...
namespace StreamWorker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(StreamWorkerUserManager userManager, SignInManager signInManager)
        {
        ...
        public StreamWorkerUserManager UserManager
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new StreamWorkerUser {UserName = model.Email, Email = model.Email};
